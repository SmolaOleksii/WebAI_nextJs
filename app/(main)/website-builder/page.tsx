        ...
        <div className="mx-auto max-w-7xl px-6 pb-24 pt-10 sm:pb-32 lg:flex lg:px-8 ">
          <div className="mx-auto  max-w-3xl lg:mx-0 lg:flex-shrink-0 ">
            ...
            <p className="mt-6 text-lg leading-8 text-gray-600">
              Get your business online in seconds with the leading AI website
              builder. As we&apos;re eager to lean about your business,
              let&apos;s create your business profile together.
            </p>
